    ...
    >
        <div class="ml-2">
            ...
            <div class="relative border-l-2 border-transparent pl-10">
                ...
                {#if activeTab === "new"}
                    <div
                        class="max-w-4xl mb-2 relative group animate-in fade-in zoom-in-95 duration-200"
                    >
                        <div class="relative">
                            <input
                                type="text"
                        ...
                        {#if isInputError}
                            <div
                                class="absolute -bottom-6 left-0 text-red-600 text-xs font-bold animate-in fade-in slide-in-from-top-1 bg-red-50 px-2 py-1 rounded"
                            >
                                {errorMsg}
                            </div>
                        {/if}
                ...
                {:else}
                    <div
                        class="max-w-4xl mb-2 animate-in fade-in zoom-in-95 duration-200 min-h-[100px]"
                    >
                        {#if savedTokens.length === 0}
                            <div
                            ...
                            <div class="grid gap-3">
                                {#each savedTokens as token, i}
                                    ...
                                    >
                                        ...
                                        >
                                            <span
                                                class="text-xs font-bold text-[#21272C] bg-[#FFE145] px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-all transform translate-x-4 group-hover:translate-x-0"
                                            >
                ...
                <div class="flex flex-col gap-4 mt-2 max-w-4xl items-start">
                    {#if activeTab === "new"}
                        <div class="flex flex-col gap-2 transition-all w-full">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    {#if isSaveTokenEnabled}
                                        <div
                                            class="text-gray-400 text-xs mt-0.5 animate-in fade-in slide-in-from-top-1"
                                        >
                            ...
                            {#if isSaveTokenEnabled}
                                <div
                                    class="pl-8 animate-in slide-in-from-top-2 fade-in mb-2"
                                >
                                    <input
                                        type="text"
                                    ...
                                    />
                                    <div
                                        class="text-[10px] text-gray-400 mt-1 ml-1"
                                    >
                                        {$t("import.token_name_label")}
