...
CREATE TABLE "UserBannerStat" (
    ...
    PRIMARY KEY ("uid", "bannerId"),
    CONSTRAINT "UserBannerStat_uid_fkey" FOREIGN KEY ("uid") REFERENCES "User" ("uid") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "GlobalBannerStats" (
    "bannerId" TEXT NOT NULL PRIMARY KEY,
...
CREATE TABLE "GlobalPityDistribution" (
    ...
    PRIMARY KEY ("bannerId", "rarity", "pity")
);
